...
class AudioItem {
    ...
    public function create() {
        ...
        $deleteButton = ButtonProvider::createDeleteAudioButton($this->con, $this->audio->getId());

        return "<div style='border: 1px solid black; border-radius: 1.5em;' class='col-md-6 offset-md-3 p-4'>
