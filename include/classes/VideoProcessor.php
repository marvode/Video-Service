...
class VideoProcessor {
    ...
    private $con;
    private $sizeLimit = 3 * 1024 * 1024 * 1024;
    ...
    private function insertVideoData($uploadData, $filePath) {
        $query = $this->con->prepare("INSERT INTO videos(title, uploadedBy, description, category, filePath, contentType, language)
                                        VALUES(:title, :uploadedBy, :description, :category, :filePath, :contentType, :language)");
        ...
        $query->bindParam(":contentType", $uploadData->content);
